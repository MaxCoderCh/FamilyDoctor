...
public class DiseaseClass extends BaseEntity {
    private String id;

    private String diseaseClassName;

    private String diseaseClassNo;
    ...
    public String getDiseaseClassNo() {
        return diseaseClassNo;
    }

    public void setDiseaseClassNo(String diseaseClassNo) {
        this.diseaseClassNo = diseaseClassNo == null ? null : diseaseClassNo.trim();
    }
